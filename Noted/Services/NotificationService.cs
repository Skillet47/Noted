...
public class NotificationService : INotificationService
{
    ...
    private async Task ScheduleWindowsNotificationAsync(string id, string title, string message, DateTime scheduledTime)
    {
        ...
        // Schedule by setting expiration and using a timer approach
        // Windows App SDK doesn't have direct scheduled notifications for unpackaged apps,
        // so we use a background timer
    ...
    {
        // Notification will not be shown since we check _scheduledNotifications before showing
